...
SUPPORTED = [
    ...
    "dispatcher.runQuickSereniteaPotTask", "dispatcher.runSereniteaPotRewardsTask",
    "dispatcher.runGoToSereniteaPotTask", "dispatcher.runQuickClaimRewardTask",
...
PARTIAL = {
    ...
    "genshin.commonJobs": "奖励、协会完整对话/探索派遣、合成台路线、材料合成和调时已接入 iOS；路线/按钮阈值仍需对应账号与真机画面回归",
    "dispatcher.runQuickSereniteaPotTask": "使用背包小道具页与原版模板快速进入/离开尘歌壶",
    "dispatcher.runSereniteaPotRewardsTask": "进入尘歌壶寻找阿圆，领取好感/宝钱；商店物品必须显式配置",
